...
export function ImageCarousel({ images, className = "" }: ImageCarouselProps) {
  ...
  return (
    <div className={cn("relative w-full h-full group shadow-lg v ", className)}>
      {currentIndex > 0 && (
        <button
      ...
      {/* Images Container */}
      <div className="relative w-full h-full overflow-hidden min-h-[200px] sm:min-h-[300px] lg:min-h-[400px] xl:min-h-[500px]">
        {set.map((image, index) => (
          <div
            key={index}
            className={cn(
